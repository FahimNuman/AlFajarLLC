      ...
      <div className="max-padd-container max-xl:mt-8p-6 sm:p-8 font-sans text-gray-800 max-w-5xl max-xl:mt-8">
        <div className="bg-white p-6 sm:p-8 rounded-lg shadow-lg">
          <h1 className="text-1xl sm:text-2xl font-extrabold text-center text-blue-900 mb-2 sm:mb-2">
            Privacy Policy for Alfajor LLC
          </h1>
          ...
          <footer className="text-center text-gray-600 mt-6 sm:mt-8 p-4 sm:p-6">
            <p className="text-base sm:text-lg font-semibold">
              Alfajor LLC | Empowering Wholesale Excellence
            </p>
            <p className="text-sm sm:text-base">
              This policy aligns with global standards such as GDPR, CCPA, and
              COPPA. For further details, review our full Terms of Service or
...
const sections = [
  {
    ...
    content:
      "By accessing or using RSikder Corporation (https://alfajorllc.com/), you agree to the terms of this Privacy Policy. Continued use of our website constitutes acceptance of these practices.",
  },
  {
  ...
  },
  {
    ...
    content:
      "Our website may link to external sites (e.g., suppliers, social media). These platforms operate under their privacy policies, and we are not responsible for their practices.",
  },
  {
  ...
  },
  {
    ...
    content:
      "Our services are not intended for users under 18. Parents/guardians may contact us to request the removal of inadvertently collected minor data.",
  },
  {
    ...
    content: [
      ...
      "<strong>Customer Support:</strong> Email <a href='mailto:mahabubulhaque2018@gmail.com' class='text-indigo-600 hover:underline'>mahabubulhaque2018@gmail.com</a> for assistance with data corrections or deletions.",
    ],
  },
  {
    title: "10. Policy Changes & Updates",
    content:
      "We reserve the right to modify this policy. Significant changes will be notified via email or website banners. Regularly review this page for updates.",
  },
  {
