...
const TermsConditions = () => {
  return (
    <>
      <div className="max-padd-container max-xl:mt-8 p-6 sm:p-8 font-sans text-gray-800 max-w-5xl">
        <div className="bg-white p-6 sm:p-8 rounded-lg shadow-lg">
          ...
          <footer className="bg-gray-100 text-center text-gray-700 mt-8 py-6 px-4 sm:px-8 border-t border-gray-300">
            ...
            <div className="mt-3 text-sm sm:text-base text-gray-600 leading-relaxed">
              ...
              <p>
                ● Updates to these Terms will be communicated via email or
                portal notification.
              </p>
              <p>
                ● For full terms, refer to{" "}
                <a
                  href="https://www.alfajor.com/terms"
                  className="text-blue-600 hover:underline"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  www.alfajor.com/terms
                </a>
                .
              </p>
              <p className="mt-3 italic text-gray-500">
                This document synthesizes industry standards from wholesale
                apparel distributors and legal templates.
              </p>
            </div>
          </footer>
        </div>
...
const sections = [
  {
    ...
    content:
      "All purchases from Alfajor LLC (“Seller”) are governed exclusively by these Terms and Conditions (“Terms”). Any conflicting terms proposed by the Buyer, including those in purchase orders or other documents, are expressly rejected and void unless explicitly agreed to in writing by the Seller. By placing an order, Buyer acknowledges acceptance of these Terms.",
  },
  {
    title: "2. Ordering",
    content: [
  ...
  },
  {
    title: "5. Pricing",
    content:
      "Prices are subject to change without notice. Discounts or promotions apply only to in-stock items and may be revoked for abuse. Price adjustments due to typographical errors or supplier cost changes are permitted.",
  },
  {
  ...
  {
    title: "7. Export Shipments",
    content:
      "Buyer assumes full responsibility for compliance with export laws, customs duties, and import regulations. Seller disclaims liability for fines or delays arising from non-compliance.",
  },
  {
    title: "8. Product Safety & Compliance",
    content:
      "Goods comply with CPSIA and other applicable safety standards. The buyer is responsible for obtaining certifications (e.g., flammability testing) required for resale in specific jurisdictions.",
  },
  {
    title: "9. Warranty Disclaimer",
    content:
      "Goods are warranted to be free from defects at the time of delivery. Claims must be submitted within 7 days of receipt. Seller’s sole obligation is limited to refund or replacement at its discretion.",
  },
  {
    title: "10. Limitation of Liability",
    content:
      "Seller is not liable for indirect, incidental, or consequential damages (e.g., lost profits). Liability is capped at the purchase price of the affected goods.",
  },
  {
  ...
  {
    title: "Alfajor LLC Contact Information",
    content: [
      "<strong>Address:</strong> New York, United States 11377",
